...
WebUI.click(findTestObject('Application/Question/Qn_create/Qn Type/SAQ'))
...
WebUI.click(findTestObject('Object Repository/Application/Question/Qn_create/_Question Creations/SAQ Create/button_Blank'))

WebUI.setText(findTestObject('Object Repository/Application/Question/Qn_create/_Question Creations/SAQ Create/inputshort_1'), 
    'Chcek')

WebUI.setText(findTestObject('Object Repository/Application/Question/Qn_create/_Question Creations/SAQ Create/inputshortmark_1'), 
    '2')
